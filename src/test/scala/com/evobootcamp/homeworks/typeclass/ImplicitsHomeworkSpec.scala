...
import com.evobootcamp.homeworks.typeclass.ImplicitsHomework.SuperVipCollections4s._
import com.evobootcamp.homeworks.typeclass.ImplicitsHomework.SuperVipCollections4s.syntax._
import com.evobootcamp.homeworks.typeclass.ImplicitsHomeworkSpec.TestValue
...
class ImplicitsHomeworkSpec extends AnyFreeSpec with Matchers {
  ...
  "Iterate2 instances provided" - {
    "for Map" in {
      assertCompiles(
        """import com.evobootcamp.homeworks.typeclass.ImplicitsHomework.SuperVipCollections4s._
          |import com.evobootcamp.homeworks.typeclass.ImplicitsHomework.SuperVipCollections4s.instances._
          |
  ...
  "TwitCache" - {
    import com.evobootcamp.homeworks.typeclass.ImplicitsHomework.MyTwitter._
